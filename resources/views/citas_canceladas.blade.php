        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  ...
                  <h3 class="text-danger">{{ __('Citas Canceladas') }} <i class="far fa-window-close"></i></h3>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8" style="height:500px; overflow-y: auto;">
                    <div class="container">
                      <h4 class="text-danger">Mis Citas Canceladas:</h4>
                                ...
                                @foreach($citas as $c)
                                  ...
                                  <tr>
                                    ...
                                    <td>@foreach($users_app as $app)
                                      @if($c->user_id == $app->id)
                                      {{$app->nombre}} @endif @endforeach</td>
                                         <td>@foreach($users_app as $app)
                                         @if($c->user_id == $app->id)
                      ...
                      <div class="card card-default">
                        ...
                        <div class="card-body">
                          ...
                          <div class="alert alert-danger" role="alert">
                            <strong>Tu ó el Afiliado a Cancelado estas citas.</strong>
                            <hr>
                            Contacta a tus afiliados y hazle saber que pueden agendar de nuevo cuando quieran,
                            que entiendes y hazle saber que estas para servir. <br>
                            Esto podria traer de nuevo a tu cliente.
                          </div>
