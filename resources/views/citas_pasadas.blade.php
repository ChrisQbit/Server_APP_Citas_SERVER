        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  ...
                  <h3 class="text-primary">{{ __('Citas Pasadas') }} <i class="fas fa-calendar-alt"></i></h3>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8" style="height:500px; overflow-y: auto;">
                    <div class="container">
                      <h4 class="text-primary">Total de Citas:
                        {{ count($citas) }}
                        Registros encontrados...</h4>
                              ...
                              @if($citas)
                                @foreach($citas as $c)
                                  ...
                                  <tr>
                                    ...
                                    <td>@foreach($users_app as $app) @if($c->user_id == $app->id)
                                         {{$app->nombre}}
                                          @endif @endforeach</td>
                    ...
                    <div class="container">
                      ...
                      <div class="card card-default">
                        ...
                        <div class="card-body">
                          ...
                          <div class="alert alert-primary" role="alert">
                            <strong>Gran Trabajo!! Tus Citas Atendidas. <i class="fas fa-check-circle"></i></strong>
                            <hr>
                            El desgloce de tus citas atendidas refleja tu productividad, haz que tu tiempo valga más.
                            Organiza tu tiempo con Dater Plus.<br>
